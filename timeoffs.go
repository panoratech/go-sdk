...
func newTimeoffs(sdkConfig sdkConfiguration) *Timeoffs {
	return &Timeoffs{
...
func (s *Timeoffs) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListHrisTimeoffsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/hris/timeoffs")
	if err != nil {
	...
	res.Next = func() (*operations.ListHrisTimeoffsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListHrisTimeoffsResponseBody
...
func (s *Timeoffs) Create(ctx context.Context, xConnectionToken string, unifiedHrisTimeoffInput components.UnifiedHrisTimeoffInput, remoteData *bool, opts ...operations.Option) (*operations.CreateHrisTimeoffResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UnifiedHrisTimeoffInput", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedHrisTimeoffOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedHrisTimeoffOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
...
func (s *Timeoffs) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveHrisTimeoffResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/hris/timeoffs/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveHrisTimeoffResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
