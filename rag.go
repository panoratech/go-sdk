...
func (s *Rag) Query(ctx context.Context, xConnectionToken string, queryBody components.QueryBody, opts ...operations.Option) (*operations.QueryResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rag/query")
	if err != nil {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []components.RagQueryOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.RagQueryOutputs = out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
