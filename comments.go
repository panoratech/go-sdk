...
func (s *Comments) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListTicketingCommentsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/ticketing/comments")
	if err != nil {
	...
	res := &operations.ListTicketingCommentsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.ListTicketingCommentsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListTicketingCommentsResponseBody
...
func (s *Comments) Create(ctx context.Context, xConnectionToken string, unifiedTicketingCommentInput components.UnifiedTicketingCommentInput, remoteData *bool, opts ...operations.Option) (*operations.CreateTicketingCommentResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UnifiedTicketingCommentInput", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateTicketingCommentResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedTicketingCommentOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedTicketingCommentOutput = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Comments) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveTicketingCommentResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/ticketing/comments/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveTicketingCommentResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.RetrieveTicketingCommentResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
