...
// SignIn - Log In
func (s *Login) SignIn(ctx context.Context, request components.LoginDto, opts ...operations.Option) (*operations.SignInResponse, error) {
