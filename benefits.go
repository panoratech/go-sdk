...
func (s *Benefits) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListHrisBenefitsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/hris/benefits")
	if err != nil {
	...
	res.Next = func() (*operations.ListHrisBenefitsResponse, error) {
...
func (s *Benefits) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveHrisBenefitResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/hris/benefits/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveHrisBenefitResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedHrisBenefitOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedHrisBenefitOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
