...
func newAutomations(sdkConfig sdkConfiguration) *Automations {
	return &Automations{
...
func (s *Automations) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListMarketingautomationAutomationsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/marketingautomation/automations")
	if err != nil {
	...
	res.Next = func() (*operations.ListMarketingautomationAutomationsResponse, error) {
...
func (s *Automations) Create(ctx context.Context, xConnectionToken string, unifiedMarketingautomationAutomationInput components.UnifiedMarketingautomationAutomationInput, remoteData *bool, opts ...operations.Option) (*operations.CreateMarketingautomationAutomationResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UnifiedMarketingautomationAutomationInput", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateMarketingautomationAutomationResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedMarketingautomationAutomationOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedMarketingautomationAutomationOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
...
func (s *Automations) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveMarketingautomationAutomationResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/marketingautomation/automations/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveMarketingautomationAutomationResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
