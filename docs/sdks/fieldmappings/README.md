...
func main() {
    ...
    res, err := s.FieldMappings.Define(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
**[*operations.DefineResponse](../../models/operations/defineresponse.md), error**
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.FieldMappings.Create(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
