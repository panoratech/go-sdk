...
type Employeepayrollruns struct {
	sdkConfiguration sdkConfiguration
}

func newEmployeepayrollruns(sdkConfig sdkConfiguration) *Employeepayrollruns {
	return &Employeepayrollruns{
...
func (s *Employeepayrollruns) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListHrisEmployeePayrollRunResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/hris/employeepayrollruns")
	if err != nil {
	...
	res := &operations.ListHrisEmployeePayrollRunResponse{
	...
	res.Next = func() (*operations.ListHrisEmployeePayrollRunResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListHrisEmployeePayrollRunResponseBody
...
func (s *Employeepayrollruns) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveHrisEmployeePayrollRunResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/hris/employeepayrollruns/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveHrisEmployeePayrollRunResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedHrisEmployeepayrollrunOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedHrisEmployeepayrollrunOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
