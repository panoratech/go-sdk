...
// List  Attachments
func (s *PanoraAttachments) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListAccountingAttachmentsResponse, error) {
	...
	res.Next =
		func() (*operations.ListAccountingAttachmentsResponse, error) {
...
func (s *PanoraAttachments) Create(ctx context.Context, xConnectionToken string, unifiedAccountingAttachmentInput components.UnifiedAccountingAttachmentInput, remoteData *bool, opts ...operations.Option) (*operations.CreateAccountingAttachmentResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *PanoraAttachments) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveAccountingAttachmentResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
