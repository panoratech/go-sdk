...
func newBankinfos(sdkConfig sdkConfiguration) *Bankinfos {
	return &Bankinfos{
...
func (s *Bankinfos) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListHrisBankInfoResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/hris/bankinfos")
	if err != nil {
	...
	res.Next = func() (*operations.ListHrisBankInfoResponse, error) {
...
func (s *Bankinfos) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveHrisBankInfoResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/hris/bankinfos/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedHrisBankinfoOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedHrisBankinfoOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
