...
// Delete Webhook
func (s *ID) Delete(ctx context.Context, id string, opts ...operations.Option) (*operations.DeleteResponse, error) {
...
func (s *ID) UpdateStatus(ctx context.Context, id string, opts ...operations.Option) (*operations.UpdateStatusResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
