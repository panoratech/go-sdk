...
func newEmployments(sdkConfig sdkConfiguration) *Employments {
	return &Employments{
...
func (s *Employments) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListHrisEmploymentsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/hris/employments")
	if err != nil {
	...
	res.Next = func() (*operations.ListHrisEmploymentsResponse, error) {
...
func (s *Employments) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveHrisEmploymentResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/hris/employments/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveHrisEmploymentResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedHrisEmploymentOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedHrisEmploymentOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
