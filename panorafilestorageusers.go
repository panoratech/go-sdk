...
type PanoraFilestorageUsers struct {
	sdkConfiguration sdkConfiguration
}

func newPanoraFilestorageUsers(sdkConfig sdkConfiguration) *PanoraFilestorageUsers {
	return &PanoraFilestorageUsers{
...
func (s *PanoraFilestorageUsers) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListFilestorageUsersResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/filestorage/users")
	if err != nil {
	...
	res := &operations.ListFilestorageUsersResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.ListFilestorageUsersResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListFilestorageUsersResponseBody
...
func (s *PanoraFilestorageUsers) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveFilestorageUserResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/filestorage/users/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveFilestorageUserResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
