...
type PanoraGroups struct {
	sdkConfiguration sdkConfiguration
}

func newPanoraGroups(sdkConfig sdkConfiguration) *PanoraGroups {
	return &PanoraGroups{
...
// List  Groups
func (s *PanoraGroups) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListFilestorageGroupResponse, error) {
	...
	res.Next =
		func() (*operations.ListFilestorageGroupResponse, error) {
...
func (s *PanoraGroups) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveFilestorageGroupResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
