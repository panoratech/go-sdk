...
func newCampaigns(sdkConfig sdkConfiguration) *Campaigns {
	return &Campaigns{
...
func (s *Campaigns) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListMarketingautomationCampaignsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/marketingautomation/campaigns")
	if err != nil {
	...
	res.Next = func() (*operations.ListMarketingautomationCampaignsResponse, error) {
...
func (s *Campaigns) Create(ctx context.Context, xConnectionToken string, unifiedMarketingautomationCampaignInput components.UnifiedMarketingautomationCampaignInput, remoteData *bool, opts ...operations.Option) (*operations.CreateMarketingautomationCampaignResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UnifiedMarketingautomationCampaignInput", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateMarketingautomationCampaignResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Campaigns) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveMarketingautomationCampaignResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/marketingautomation/campaigns/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveMarketingautomationCampaignResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
