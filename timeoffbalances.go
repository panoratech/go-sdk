...
type Timeoffbalances struct {
	sdkConfiguration sdkConfiguration
}

func newTimeoffbalances(sdkConfig sdkConfiguration) *Timeoffbalances {
...
func (s *Timeoffbalances) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListHrisTimeoffbalancesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/hris/timeoffbalances")
	if err != nil {
	...
	res.Next = func() (*operations.ListHrisTimeoffbalancesResponse, error) {
...
func (s *Timeoffbalances) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveHrisTimeoffbalanceResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/hris/timeoffbalances/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveHrisTimeoffbalanceResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedHrisTimeoffbalanceOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedHrisTimeoffbalanceOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
