...
func (s *Events) GetPanoraCoreEvents(ctx context.Context, page *float64, limit *float64, opts ...operations.Option) (*operations.GetPanoraCoreEventsResponse, error) {
	...
	res := &operations.GetPanoraCoreEventsResponse{
