...
func newDeals(sdkConfig sdkConfiguration) *Deals {
	return &Deals{
...
func (s *Deals) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListCrmDealsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/crm/deals")
	if err != nil {
	...
	res.Next = func() (*operations.ListCrmDealsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListCrmDealsResponseBody
...
func (s *Deals) Create(ctx context.Context, xConnectionToken string, unifiedCrmDealInput components.UnifiedCrmDealInput, remoteData *bool, opts ...operations.Option) (*operations.CreateCrmDealResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UnifiedCrmDealInput", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedCrmDealOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedCrmDealOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
...
func (s *Deals) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveCrmDealResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/crm/deals/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveCrmDealResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
