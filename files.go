...
// List  Files
func (s *Files) List(ctx context.Context, xConnectionToken string, remoteData *bool, limit *float64, cursor *string, opts ...operations.Option) (*operations.ListFilestorageFileResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/filestorage/files")
	if err != nil {
	...
	res := &operations.ListFilestorageFileResponse{
	...
	res.Next = func() (*operations.ListFilestorageFileResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListFilestorageFileResponseBody
...
func (s *Files) Create(ctx context.Context, xConnectionToken string, unifiedFilestorageFileInput components.UnifiedFilestorageFileInput, remoteData *bool, opts ...operations.Option) (*operations.CreateFilestorageFileResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UnifiedFilestorageFileInput", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateFilestorageFileResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UnifiedFilestorageFileOutput
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedFilestorageFileOutput = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
...
func (s *Files) Retrieve(ctx context.Context, xConnectionToken string, id string, remoteData *bool, opts ...operations.Option) (*operations.RetrieveFilestorageFileResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/filestorage/files/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RetrieveFilestorageFileResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
