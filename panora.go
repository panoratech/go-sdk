...
func New(opts ...SDKOption) *Panora {
	sdk := &Panora{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			...
			SDKVersion:        "0.7.0",
			GenVersion:        "2.460.1",
			UserAgent:         "speakeasy-sdk/go 0.7.0 2.460.1 1.0 github.com/panoratech/go-sdk",
			Hooks:             hooks.New(),
		},
	}
	...
	sdk.Marketingautomation = newMarketingautomation(sdk.sdkConfiguration)
...
func (s *Panora) Hello(ctx context.Context, opts ...operations.Option) (*operations.HelloResponse, error) {
...
func (s *Panora) Health(ctx context.Context, opts ...operations.Option) (*operations.HealthResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "health",
		SecuritySource: s.sdkConfiguration.Security,
