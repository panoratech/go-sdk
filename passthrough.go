...
func (s *Passthrough) Request(ctx context.Context, xConnectionToken string, passThroughRequestDto components.PassThroughRequestDto, opts ...operations.Option) (*operations.RequestResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "PassThroughRequestDto", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.RequestResponse{
